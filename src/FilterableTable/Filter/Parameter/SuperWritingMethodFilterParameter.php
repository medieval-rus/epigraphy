...
final class SuperWritingMethodFilterParameter implements FilterParameterInterface, ExpressionBuilderInterface
{
    ...
    {
        return [
            'label' => 'controller.inscription.list.filter.superWritingMethod',
    ...
    public function buildWhereExpression(QueryBuilder $queryBuilder, $formData, string $entityAlias): ?string
    {
        ...
        // $objs = $formData->map(fn (WritingMethod $entity): array => $entity->getSubmethods()->toArray())->toArray();
        // $ready_objs = array_merge(...$objs);
        // $ids = array_map(fn (WritingMethod $entity): int => $entity->getId(), $ready_objs);
        $ready_objs = $formData->getSubmethods()->toArray();
        $ids = array_map(fn (WritingMethod $entity): int => $entity->getId(), $ready_objs);
