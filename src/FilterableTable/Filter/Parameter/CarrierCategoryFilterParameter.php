 ...
 */
class CarrierCategoryFilterParameter implements FilterParameterInterface, ExpressionBuilderInterface
{
    /**
    ...
    {
        return function (CarrierCategoryRepository $repository): QueryBuilder {
